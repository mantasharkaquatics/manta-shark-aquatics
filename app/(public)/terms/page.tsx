  ...
  return (
    <div style={{ minHeight: '100vh', background: '#111d38', padding: '60px 20px' }}>
      <div style={{ maxWidth: '760px', margin: '0 auto' }}>
        ...
        {OFF_PEAK_ENABLED
          ? <div style={plain}><strong>In plain terms:</strong> every lesson has a listed price, and booking at a quieter hour brings it down. The discount is applied when you book, so it also applies to points you already have.</div>
          : <div style={plain}><strong>In plain terms:</strong> every lesson has one listed price, the same for every family, shown before you confirm.</div>}
