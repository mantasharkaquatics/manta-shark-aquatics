  ...
  return (
    <div style={{ minHeight: '100vh', background: '#111d38', padding: '60px 20px' }}>
      <div style={{ maxWidth: '760px', margin: '0 auto' }}>
        ...
        <p style={p}>Within 24 hours of the scheduled start time, lessons cannot be rescheduled and are not eligible for a refund or a credit return, because the coach&rsquo;s time is already reserved. In place of that, your account earns <strong>one late-cancellation conversion for every 10 lessons purchased</strong> (Swim Assessments and Swim Team purchases do not count toward this). While you have a conversion available, canceling within 24 hours converts the credit for that lesson into one make-up token under Section 5 instead of forfeiting it. The conversion is a substitution, not an addition: the credit is spent and the token replaces it. Conversions accumulate over the life of your account, are not reset or topped up, and are counted per family account. When none remain, a lesson starting within 24 hours cannot be canceled online and the credit is used; contact us and our team will review the situation.</p>
        <p style={p}>Two exceptions apply. A <strong>1-on-2 lesson</strong> starting within 24 hours cannot be canceled online at all, because a second family shares the slot; contact us and our staff will handle it. A <strong>Swim Assessment</strong> cannot be canceled online at any time; contact us and we will cancel it for you.</p>
