...
SELECT 'de640a60-96c1-4616-bcd2-f29f1aa61ed8', l.id, 'Freestyle 25 yd for Speed', 3, 5, true,
       'Swims 25 yards freestyle as fast as he can with the stroke holding together and no more breaths than an easy 25. 自由式 25 碼盡全力游，全程動作不散，換氣次數不比平常那一趟多。', 2
